...
public class TransferService {
    ...
    public List<Map<String, Object>> getTransferItemsWithDetails(Long requestId) {
        ...
        for (RequestItem item : items) {
            ...
            if(item.getSourceLocationId() !=null){
                Location location = locationDAO.findById(item.getSourceLocationId());
                itemData.put("sourceLocation", location);
            }
            ////////////////////////////
            result.add(itemData);
        }
    ...
    public List<Map<String, Object>> checkTransferAvailability(Long requestId) {
        ...
        for (RequestItem item : items) {
            ...
            /////////
            if (item.getSourceLocationId() != null) {
                Location loc = locationDAO.findById(item.getSourceLocationId());
                availability.put("sourceLocation", loc);
            }
            ///////
